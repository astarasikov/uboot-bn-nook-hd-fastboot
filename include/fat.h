...
#define LAST_LONG_ENTRY_DELETED	0x80
#define LONG_ENTRY_ID_MASK 	0x3F
#define LONG_ENTRY_ID_MAX       19
#define LONG_ENTRY_NB_CHAR      13
...
typedef struct {
	...
	__u16   rootdir_size;   /* Sise of the rootdir in number of sectors (only for FAT16) */
...
long file_fat_write(const char *filename, const void *buffer, unsigned long maxsize);
